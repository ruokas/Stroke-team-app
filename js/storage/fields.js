...
export function getRadioValue(nodes) {
  const selected = nodes.find((n) => n.checked);
...
export const FIELD_DEFS = [
  ...
  { key: 't_sleep_start_date', selector: 'sleep_start_date' },
  { key: 't_sleep_start_time', selector: 'sleep_start_time' },
  { key: 't_sleep_end', selector: 'sleep_end' },
  { key: 't_sleep_end_date', selector: 'sleep_end_date' },
  { key: 't_sleep_end_time', selector: 'sleep_end_time' },
  ...
  {
    key: 'd_next_care',
    selector: 'd_next_care',
    get: getRadioValue,
    set: (nodes, value) => setRadioValue(nodes, value || ''),
  },
  {
    key: 'd_department',
    selector: 'd_department',
    get: getRadioValue,
    set: (nodes, value) => setRadioValue(nodes, value || ''),
  },
  { key: 'd_transfer_info', selector: 'd_transfer_info' },
