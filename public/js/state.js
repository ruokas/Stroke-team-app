...
const selectorMap = {
  ...
  sleep_start_date: ['#t_sleep_start_date'],
  sleep_start_time: ['#t_sleep_start_time'],
  sleep_end_date: ['#t_sleep_end_date'],
  sleep_end_time: ['#t_sleep_end_time'],
  arrival_source: ['input[name="arrival_source"]', true],
  arrival_ems_prenotify: ['input[name="arrival_ems_prenotify"]', true],
  arrival_first_hospital: ['#arrival_first_hospital'],
  ...
  a_unknown: ['#a_unknown'],
  a_independent: ['input[name="a_independent"]', true],
